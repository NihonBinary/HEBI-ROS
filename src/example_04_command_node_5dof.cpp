...
int main(int argc, char **argv) {
  ...
  command_msg.effort.resize(5);

  feedback.position.reserve(5);
  ...
  while(ros::ok()) {
    ...
    command_msg.effort[3] = spring_constant * feedback.position[3];
    command_msg.effort[4] = spring_constant * feedback.position[4];
